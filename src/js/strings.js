...
var translations = {
  ...
  titleDisclaimer: {
    ja: "太鼓ウェブは非公式シミュレーターです。バンダイナムコとは一切関係ありません。",
  ...
  tutorial: {
    basics: {
      ...
      en: [
        "This Taiko-Web does not support account or score saving",
      ...
      ko: [
        "이 Taiko-Web 계정이나 점수 저장을 지원하지 않습니다.",
